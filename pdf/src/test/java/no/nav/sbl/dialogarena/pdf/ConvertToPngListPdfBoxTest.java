...
public class ConvertToPngListPdfBoxTest {
    ...
    public void convertPdfToPng() throws IOException {
        ...
        List<byte[]> pngs = new ConvertToPngListPdfBox(frameDimension).transform(pdf);
        logger.debug("ConvertToPngListPdfBox tok {} ms", System.currentTimeMillis() - start);
        ...
        try {
            String myDirectoryPath = ConvertToPngListPdfBoxTest.class.getResource("/PdfToImageFiles").getPath() + "/multiple-pdf-files-converted";
    ...
    public void convertJpgToPng() throws IOException {
        ...
        List<byte[]> png = new ConvertToPngListPdfBox(frameDimension).transform(jpg);
    ...
    public void dontChangePng() throws IOException {
        ...
        Dimension frameDimension = new Dimension(100, 150);
        assertThat(png, match(new IsPng()));
        List<byte[]> newPng = new ConvertToPngListPdfBox(frameDimension).transform(png);
    ...
    public void kastExceptionPaaUlovligFiltype() throws IOException {
        ...
        Dimension frameDimension = new Dimension(100, 150);
        List<byte[]> png = new ConvertToPngListPdfBox(frameDimension).transform(txt);
    }
}
