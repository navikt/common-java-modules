...
public class ConvertToPngIcePdfTest {
    ...
    public void convertPdfToPng() throws IOException {
        ...
        byte[] png = new ConvertToPngIcePdf(frameDimension).transform(pdf);
        logger.debug("ConvertToPngIcePdf tok {} ms", System.currentTimeMillis() - start);
    ...
    public void convertJpgToPng() throws IOException {
        ...
        byte[] png = new ConvertToPngIcePdf(frameDimension).transform(jpg);
        assertThat(png, match(new IsPng()));
    ...
    public void dontChangePng() throws IOException {
        ...
        assertThat(png, match(new IsPng()));
        byte[] newPng = new ConvertToPngIcePdf(frameDimension).transform(png);
    ...
    public void kastExceptionPaaUlovligFiltype() throws IOException {
        ...
        Dimension frameDimension = new Dimension(100, 150);
        byte[] png = new ConvertToPngIcePdf(frameDimension).transform(txt);
    }
}
