...
public class AdGroupDataTest {
    ...
    public void testAdditionalEqualsScenarios() {
        ...
        AdGroupData sameIdDiffName = new AdGroupData()
                .setId(AzureObjectId.of("123"))
                .setDisplayName("Different Name");
        assertNotEquals(group, sameIdDiffName);

        // Test null fields
        AdGroupData nullId = new AdGroupData().setDisplayName("Group");
        AdGroupData nullName = new AdGroupData().setId(AzureObjectId.of("123"));

        assertNotEquals(group, nullId);
        assertNotEquals(group, nullName);
        assertNotEquals(nullId, nullName);
    }
}
