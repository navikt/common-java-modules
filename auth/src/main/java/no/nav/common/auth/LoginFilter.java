...
public class LoginFilter implements Filter {
    ...
    public LoginFilter(List<LoginProvider> loginProviders, AuthorizationModule authorizationModule, List<String> publicPaths) {
    ...
    private Optional<Subject> resolveSubject(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        return loginProviders.stream()
                ...
                .filter(subject -> authorizationModule == null || authorizationModule.authorized(subject, httpServletRequest))
                .findFirst();
    }
