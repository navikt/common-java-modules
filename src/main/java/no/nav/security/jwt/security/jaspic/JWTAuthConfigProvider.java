...
public class JWTAuthConfigProvider implements AuthConfigProvider {
    ...
    private static final Logger log = LoggerFactory.getLogger(JWTAuthConfigProvider.class);
     ...
     * @param factory
     */
    public JWTAuthConfigProvider(Map<String, String> properties, AuthConfigFactory factory) {
    ...
    public JWTAuthConfigProvider(ServerAuthModule serverAuthModule) {
    ...
    public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler) throws AuthException {
        ...
        return new JWTServerAuthConfig(layer, appContext, handler == null ? createDefaultCallbackHandler() : handler, providerProperties, serverAuthModule);
    }
