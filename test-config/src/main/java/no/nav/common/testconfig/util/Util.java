package no.nav.common.testconfig.util;
...
import static no.nav.common.testconfig.util.Util.Mode.IKKE_OVERSKRIV;
import static no.nav.common.testconfig.util.Util.Mode.OVERSKRIV;
