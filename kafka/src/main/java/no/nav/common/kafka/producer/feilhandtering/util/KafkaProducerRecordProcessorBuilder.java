...
public class KafkaProducerRecordProcessorBuilder {
    ...
    private final static long DEFAULT_ERROR_TIMEOUT_MS = 5000;
    private final static long DEFAULT_POLL_TIMEOUT_MS = 3000;
    private final static long DEFAULT_WAITING_FOR_LEADER_TIMEOUT_MS = 10_000;
    private final static int DEFAULT_RECORDS_BATCH_SIZE = 100;
    private final static boolean DEFAULT_REGISTER_SHUTDOWN_HOOK = true;
