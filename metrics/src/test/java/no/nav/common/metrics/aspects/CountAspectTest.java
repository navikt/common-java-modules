...
public class CountAspectTest {
    ...
    public void metoderMedCountAnnotasjonBlirTruffetAvAspect() throws Throwable {
        ...
        CountMetoder countMetoder = TestUtil.lagAspectProxy(new CountMetoder(), aspect);
    ...
    public void metoderPaKlasseMedAnnotasjonBlirTruffetAvAspect() throws Throwable {
        ...
        CountKlasse proxy = TestUtil.lagAspectProxy(new CountKlasse(), aspect);
    ...
    public void metoderPaKlasseMedAnnotasjonBlirRiktigIgnorert() throws Throwable {
        ...
        CountKlasseMedIgnorerteMetoder proxy = TestUtil.lagAspectProxy(new CountKlasseMedIgnorerteMetoder(), aspect);
    ...
    public void countAspectLagerEventsMedRiktigeNavn() {
        ...
        CountKlasse countKlasse = TestUtil.lagAspectProxy(new CountKlasse(), aspect);
        countKlasse.count();

        CountKlasseMedIgnorerteMetoder ignorerteMetoder = TestUtil.lagAspectProxy(new CountKlasseMedIgnorerteMetoder(), aspect);
