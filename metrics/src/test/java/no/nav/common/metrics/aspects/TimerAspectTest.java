...
public class TimerAspectTest {
    ...
    public void metoderMedTimedAnnotasjonBlirTruffetAvAspect() throws Throwable {
        ...
        TimedMetoder proxy = TestUtil.lagAspectProxy(new TimedMetoder(), aspect);
    ...
    public void metoderPaKlasseMedAnnotasjonBlirTruffetAvAspect() throws Throwable {
        ...
        TimedKlasse proxy = TestUtil.lagAspectProxy(new TimedKlasse(), aspect);
    ...
    public void metoderPaKlasseMedAnnotasjonBlirIgnorert() throws Throwable {
        ...
        TimedKlasseMedIgnorerteMetoder proxy = TestUtil.lagAspectProxy(new TimedKlasseMedIgnorerteMetoder(), aspect);
    ...
    public void timeMetodeBlirKaltMedRiktigNavn() throws Throwable {
        ...
        TimedKlasse timedKlasse = TestUtil.lagAspectProxy(new TimedKlasse(), aspect);
        timedKlasse.timed1();
        timedKlasse.timed2();

        TimedMetoder timedMetoder = TestUtil.lagAspectProxy(new TimedMetoder(), aspect);
        timedMetoder.timed();
        timedMetoder.timedMedNavn();

        TimedKlasseMedIgnorerteMetoder ignorerteMetoder = TestUtil.lagAspectProxy(new TimedKlasseMedIgnorerteMetoder(), aspect);
