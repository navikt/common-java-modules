...
public class Constants {
    ...
    public static final String AZUREADB2C_OIDC_COOKIE_NAME_FSS = "selvbetjening-idtoken";
    public static final String AZUREADB2C_OIDC_COOKIE_NAME_SBS = "isso-idtoken";
