...
@Slf4j
public class AzureAdOnBehalfOfTokenClient implements OnBehalfOfTokenClient {
    ...
    @SneakyThrows
    public AzureAdOnBehalfOfTokenClient(String clientId, String privateJwk, String discoveryUrl) {
    ...
    @SneakyThrows
    @Override
    public AccessToken exchangeToken(String tokenScope, String accessToken) {
        ...
        TokenRequest request = new TokenRequest(
                ...
                null,
                customClaims(tokenScope, accessToken)
        );
